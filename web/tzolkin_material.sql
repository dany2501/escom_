...
CREATE TABLE `material` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_materia_idx` (`materia_id`),
  KEY `fk_grado_idx` (`grado_id`),
  CONSTRAINT `fk_grado` FOREIGN KEY (`grado_id`) REFERENCES `grado` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_materia` FOREIGN KEY (`materia_id`) REFERENCES `materia` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
